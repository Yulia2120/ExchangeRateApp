...
public class ChangeActivity extends AppCompatActivity {
    ...
    TextView convertFromDropdownTextView, convertToDropdownTextView,
    conversionRateText;
    ...
    String[] country = {"AED","AFN","ALL","AMD","ANG","AOA","ARS","AUD","AWG","AZN",
            "BAM","BBD","BDT","BGN","BHD","BIF","BMD","BND","BOB","BRL","BSD","BTC","BTN","BWP","BYN","BYR","BZD",
            "EUR", "FKP", "GBP", "KHR","GBP", "PLN", "RON", "SGD", "UAH", "USD","TZS"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        convertFromDropdownTextView = findViewById(R.id.converter_from_dropdown_menu);
        convertToDropdownTextView = findViewById(R.id.converter_to_dropdown_menu);
        ...
        convertFromDropdownTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fromDialog = new Dialog(ChangeActivity.this);
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(ChangeActivity.this, android.R.layout.simple_list_item_1, arrayList);
        ...
        convertToDropdownTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                toDialog = new Dialog(ChangeActivity.this);
        ...
        convertButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    Double amountToConvert = Double.valueOf(ChangeActivity.this.amountToConvert.getText().toString());
